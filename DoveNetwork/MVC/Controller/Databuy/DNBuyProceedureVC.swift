...
class DNBuyProceedureVC: UIViewController
{    
    ...
    override func viewWillAppear(_ animated: Bool)
    {
        ...
        setPresentedNavigationBar(title: "Buy Data", largeTitle: true, tranpernt: true, buttonTint: .black)
    }
    ...
    @IBAction func btnNextTapped(_ sender: UIButton)
    {
        ...
        {
            showConfirmationPopup(isBuy: true)
            return
        }
...
extension DNBuyProceedureVC: UICollectionViewDataSource, UICollectionViewDelegate
{
